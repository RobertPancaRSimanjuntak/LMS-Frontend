...
const routes = [
  ...
  children: [
    ...
    { path: '/browser', name: 'BrowseProgram', component: BrowseProgram, meta: { title: 'Browser' }, 
    children: [
      { path: '/user/browser/card/:id', name: 'DeskripsiBrowse', component: DeskripsiBrowse, meta: { title: 'Program' } },
      { path: '/user/browser/card/:id/notif', name: 'NotifBrowse', component: NotifBrowse, meta: { title: 'Program' } },
    ]},
    { path: '/myclass/:programId', name: 'MyProgram', component: MyProgram, props: true, meta: { title: 'My Program' }, 
    children: [
