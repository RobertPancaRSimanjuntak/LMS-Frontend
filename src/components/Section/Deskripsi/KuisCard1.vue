    ...
    <div class="mr-8">
      <div class="flex flex-col space-y-24">
        <div class="flex flex-col space-y-12 justify-center items-center">
          ...
          <div class="flex flex-col space-y-4 relative w-full">
            ...
            <div class="flex flex-col border-2 border-gray-400 rounded-lg">
              ...
              <div class="bg-blue-200 px-8 py-2 left-0 bg-indigo-600/opacity-10 rounded-bl-lg rounded-br-lg border-t-2 border-gray-400 justify-start items-center gap-96 inline-flex">
                <div class="justify-start items-start gap-4 flex">
                  ...
                  <div class="text-indigo-600 text-base font-sans leading-7">{{ quizAttempts.length }}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-col justify-start space-y-4 relative w-full">
          ...
          <div v-for="(attempt, index) in quizAttempts" :key="index" class="flex flex-col border-2 border-gray-400 rounded-lg">
            <div class="px-8 py-2 left-0 top-0 rounded-tl-lg rounded-tr-lg justify-between items-center inline-flex">
              <div class="flex-col gap-1 inline-flex">
                <div class="text-black text-base font-normal font-sans leading-7">Attempt {{ index + 1 }}</div>
...
export default {
  computed: {
    quizAttempts() {
      ...
      return JSON.parse(localStorage.getItem('quiz1_attempts')) || [];
    },
    highestScoreAttempt() {
  ...
  methods: {
    takeOrRetakeQuiz() {
      ...
      this.$router.push({ name: 'KuisQuestion1' });
    }
  }
};
</script>
