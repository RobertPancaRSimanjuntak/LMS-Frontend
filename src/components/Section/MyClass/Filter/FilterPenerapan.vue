    ...
    <div>
        <div class="flex flex-col space-y-2 relative">
            ...
            <div class="flex justify-between cursor-pointer items-center text-center mx-2 sm:mx-4"
                ...
                <div class=" text-[#292929]  text-[12px] md:text-[14px] lg:text-[16px]  font-semibold font-sans text-start w-22  sm:w-30 md:w-36 lg:w-44">Latihan Menerapkan Algoritma dalam Pemrograman</div>
            ...
            <div class="relative top-full left-0"
                ...
                class="flex justify-between items-center w-full  p-4 hover:bg-blue-200"    
                    ...
                    <div class="flex space-x-2 items-center text-center ">
                        ...
                        <div class="text-black text-[12px] md:text-[16px] font-sans">Percabangan
                        </div>
                    </div>
                ...
                :class="{ 'bg-blue-200': activePage === 'MateriCard' }">
                    <div class="flex space-x-2 items-center text-center">
                        ...
                        <div class="text-black text-[12px] md:text-[16px]   font-sans">Perulangan
                        </div>
                    </div>
                    <div  class="hidden sm:block w-6 h-6 flex-shrink-0">
                        <ProgressBar :progress="progress2" />
                ...
                class="flex justify-between items-center w-full  p-4 hover:bg-blue-200"    
                    ...
                    <div class="flex space-x-2 items-center text-center ">
                        <i class="fa-regular fa-file text-[#564FFD] sm:text-xl text-md"></i>
                        <div class="text-black text-[12px] md:text-[16px] font-sans">Fungsi dan Prosedur
                        </div>
                    </div>
                    <div class="hidden sm:block w-6 h-6 flex-shrink-0">
                        <ProgressBar :progress="progress2" />
                ...
                :class="{ 'bg-blue-200': activePage === 'MateriCard' }">
                    <div class="flex space-x-2 items-center text-center">
                        <i class="fa-regular fa-circle-play text-[#564FFD] sm:text-xl text-md "></i>
                        <div class="text-black text-[12px] md:text-[16px]   font-sans">Rekursif
                        </div>
                    </div>
                    <div  class="hidden sm:block w-6 h-6 flex-shrink-0">
                        <ProgressBar :progress="progress2" />
                ...
                class="flex justify-between items-center w-full  p-4 hover:bg-blue-200"    
                    ...
                    <div class="flex space-x-2 items-center text-center ">
                        <i class="fa-regular fa-file text-[#564FFD] sm:text-xl text-md"></i>
                        <div class="text-black text-[12px] md:text-[16px] font-sans text-start">Stack dan Queue
                        </div>
                    </div>
                    <div class="hidden sm:block w-6 h-6 flex-shrink-0">
                        <ProgressBar :progress="progress2" />
